...
The user should make sure that PLINK, GEMMA, and FaST-LMM are executable before running the script.  This can be done by, for example, executing the command 
